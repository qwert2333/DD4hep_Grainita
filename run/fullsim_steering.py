...
ENABLE_OPTICAL_PHOTON_PRODUCTION = False


## The compact XML file, or multiple compact files, if the last one is the closer.
SIM.compactFile = ["../Grainita_ECAL/compact/Grainita_ECAL_Barrel_v02_Long4.xml"]
...
SIM.outputFile = "CaloSim_gamma_5GeV_theta85-95_phi80-100.root"
...
## Grainita specific SD action. Numbers are default number in code.
...
if ENABLE_OPTICAL_PHOTON_PRODUCTION:
    SIM.filter.mapDetFilter["Grainita_ECAL_Barrel_v02"] = ""
