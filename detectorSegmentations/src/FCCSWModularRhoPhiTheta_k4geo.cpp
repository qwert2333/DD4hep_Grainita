...
namespace DDSegmentation {
  ...
  FCCSWModularRhoPhiTheta_k4geo::FCCSWModularRhoPhiTheta_k4geo(const std::string& cellEncoding) : GridTheta_k4geo(cellEncoding) {
    commonSetup();
  }

  FCCSWModularRhoPhiTheta_k4geo::FCCSWModularRhoPhiTheta_k4geo(const BitFieldCoder* decoder) : GridTheta_k4geo(decoder) {
    commonSetup();
  }
  ...
  double FCCSWModularRhoPhiTheta_k4geo::phi(const CellID cID) const {
