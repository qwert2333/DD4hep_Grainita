...
private:
  double m_singlePEAmplitude;  
  mutable unsigned int m_nEvt = 0;
  ...
  // readout name and segmentation
  Gaudi::Property<std::string> m_readoutName{this, "readoutName", "", "name of the readout"};
  dd4hep::DDSegmentation::Segmentation* m_baseSegmentation = nullptr;

  mutable k4FWCore::DataHandle<edm4hep::SimCalorimeterHitCollection> m_scintHits{"DRcaloSiPMreadout_scint",
                                                                                 Gaudi::DataHandle::Reader, this};
  mutable k4FWCore::DataHandle<edm4hep::CalorimeterHitCollection> m_digiHits{"DRcaloSiPMreadoutDigiHit_scint",
                                                                             Gaudi::DataHandle::Writer, this};
  mutable k4FWCore::DataHandle<edm4hep::TimeSeriesCollection> m_waveforms{"DRcaloSiPMreadoutDigiWaveform_scint",
                                                                          Gaudi::DataHandle::Writer, this};
  mutable k4FWCore::DataHandle<edm4hep::CaloHitSimCaloHitLinkCollection> m_hitLinks{
      "DRcaloSiPMreadoutDigiHit_scint_link", Gaudi::DataHandle::Writer, this};
  ...
  // Save format in digi hits. Option: Energy, Npe, ADC.  
  Gaudi::Property<std::string> m_saveFormat{this, "saveFormat", "Energy", "Save format in digi hits. Option: Energy, Npe, ADC."};


  // Injection test
  Gaudi::Property<int> m_injectNph{this, "InjectPhotonNum", 0, "Photon injection test"};
